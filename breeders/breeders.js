...
const EN = {
    ...
    access_title: 'Access to this section', access_hint: 'Owner only. Listed users (plus owners) can see this page and manage user-bots.',
    grant: 'Grant access',
...
const RU = {
    ...
    access_title: 'Доступ к этому разделу', access_hint: 'Только для владельца. Пользователи из списка (плюс владельцы) видят эту страницу и управляют юзер-ботами.',
    grant: 'Выдать доступ',
