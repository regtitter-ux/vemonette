...
const EN = {
    ...
    nav_home: 'Home', nav_partner: 'Partners', nav_orders: 'DMALL', nav_breeders: 'For bot breeders', nav_admin: 'Admins', logout: 'Log out',
...
const RU = {
    ...
    nav_home: 'Главная', nav_partner: 'Партнёрам', nav_orders: 'DMALL', nav_breeders: 'Для ботоводов', nav_admin: 'Администраторам', logout: 'Выйти',
