...
const RU = {
  ...
  what_p1: 'Vemonette создаёт <b>персонального бота-верификатора</b> для крупных Discord-серверов. Участники проходят проверку в один клик, а сервер защищён от рейдов и селфботов.',
  ...
  chip1: '🛡️ Защищает сервер', chip2: '⚡ Один клик для участников', chip3: '💸 Платит за клики',
  ...
  servers_p: 'Число участников — вживую из Discord.',
  faq_h2: 'Частые вопросы партнёров',
  faq_q1: 'Не будет ли это раздражать участников?',
  faq_a1: 'Нет. Это та же верификация в один клик, с одной короткой рекламной строкой перед доступом. Никаких принудительных переходов, спама и лишних шагов сверх того, что и так нужно для проверки.',
