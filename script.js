...
const RU = {
  ...
  game_badge: 'Сыграйте сами', game_title: 'Настройте свой сервер — мини-игра',
  game_lead: 'Пройдите квесты и повторите те же 7 шагов, что делает настоящий партнёр — внутри точной эмуляции Discord.',
