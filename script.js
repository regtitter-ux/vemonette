...
const RU = {
  ...
  what_p1: 'Vemoni - сеть из ботов-верификаторов для крупных Discord-серверов: участники проходят проверку в два клика, переходят на сервер спонсора, а вы получаете оплату за успешные верификации',
