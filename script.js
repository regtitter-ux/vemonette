...
const RU = {
  ...
  check1: '<b>$5</b> за 100 верифицированных заходов — фиксированно, без уровней и мелкого шрифта',
  ...
  buyers_h2: 'Покупка заходов',
  buyers_sub: 'Живые участники для вашего Discord — реклама показывается в сети крупных сообществ.',
  buyers1_h3: 'Как идёт реклама',
  buyers1_p: 'Ваше приглашение показывается прямо на этапе верификации на серверах-партнёрах. Каждый день его проходят тысячи людей, видят ваш сервер и заходят в один клик — без баннеров и спама.',
  buyers2_h3: 'Реальные, проверенные люди',
  buyers2_p: 'Каждый заход подтверждается через сам Discord — живые участники из крупных сообществ, никаких ботов и накрутки.',
  buyers3_h3: 'Платите за тех, кто остаётся',
  buyers3_p: 'Если участник вышел — мы это отслеживаем, и он не засчитывается. Вы платите только за реальные заходы, которые остались.',
  buyers_check1: '<b>$10</b> за 100 подтверждённых заходов — фиксированная цена, без скрытых комиссий',
  buyers_check2: 'Охват сообществ с <b>миллионами</b> участников суммарно',
  buyers_check3: 'Запуск, пауза и масштаб в любой момент — задаёте объём, мы приводим',
  buyers_check4: 'Живая статистика по каждому заказу — видите заходы в реальном времени',
  buyers_cta: 'Заказать трафик →',
