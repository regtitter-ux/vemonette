...
const DICT = {
  ru: {
    ...
    nav_home: 'Главная', nav_orders: 'Покупателям', nav_myorders: 'DMALL', nav_partner: 'Партнёрам', nav_investor: 'Инвесторам', nav_dev: 'Разработчикам', nav_breeders: 'Для ботоводов', nav_admin: 'Администраторам',
    wallet_label: 'Баланс',
  ...
  en: {
    ...
    nav_home: 'Home', nav_orders: 'For buyers', nav_myorders: 'DMALL', nav_partner: 'For partners', nav_investor: 'For investors', nav_dev: 'For developers', nav_breeders: 'For bot breeders', nav_admin: 'For admins',
