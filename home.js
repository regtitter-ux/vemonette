...
(function () {
  ...
  const RU = {
    ...
    what_p1: 'DMALL — рассылки в личные сообщения участникам Discord серверов. Наш сервис берёт на себя автоматизацию рутинных задач, а также снижает порог входа на рынок dmall.',
